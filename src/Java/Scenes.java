...
public class Scenes
{
    ...
    public Scene MainMenu ()
    {
        ...
        //Initialize debit and credit list
    ...
    private void Debug ()
    {
        for (Debit d: debitItems)
            System.out.println("Debit is " + d.value.getText());

        for (Credit c: creditItems)
            System.out.println("Credit is " + c.value.getText());
    }
    ...
    private void Initialize (GridPane gridPane)
    {
